...
$(document).ready(function () {
  ...
  $('#item-instagram').dblclick(function () {
    window.open('https://www.instagram.com/zxcgirlcyka/');
  });


  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.youtube.com/channel/UCi-ulY0bNUyKyLYh-UsT4NQ');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://res.cloudinary.com/teepublic/image/private/s--46foThbs--/t_Resized%20Artwork/c_fit,g_north_west,h_954,w_954/co_000000,e_outline:48/co_000000,e_outline:inner_fill:48/co_ffffff,e_outline:48/co_ffffff,e_outline:inner_fill:48/co_bbbbbb,e_outline:3:1000/c_mpad,g_center,h_1260,w_1260/b_rgb:eeeeee/c_limit,f_auto,h_630,q_90,w_630/v1646948118/production/designs/28460665_0.jpg');
  });


  $('#item-2-spotify').dblclick(function () {
    window.open('https://open.spotify.com/playlist/5QyC8Ohl6zHizMUbbBQmJd?si=3d4a30f3c2b947bf');
  });
